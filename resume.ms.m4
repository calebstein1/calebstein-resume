...
_entry(2022-2023, `College Hunks Hauling, Junk, & Moving', `Move Captain', `I was in charge of moving teams and was the main on-site point of communication between the clients and the company. This role required me to quickly analyze spatial problems and come up with efficient solutions on the spot, all while keeping open and transparent communication with the clients and making sure they felt comfortable throughout the entire process.')
_end_section

...
_entry(2024, Splitjoiner, `C#, Avalonia, FFmpeg', `I created an application to easily combine split video files for the YouTube page run by my church. We serve over 100 current parishioners, and we have a total channel view count over 7,000 spread all over the country, and this application has streamlined our process for getting our videos out in a timely manner.')
...
_entry(2022-2023, `College Hunks Hauling, Junk, & Moving', `Move Captain', `I was the main point of communication for our clients during a move, I had to help put our clients at ease during a potentially stressful situation for them, while efficiently analyzing the situation and coming up with a plan to complete the move as efficiently as possible.')
_end_section
_start_section(Education)
_entry(2015-2019, Berklee College of Music, `B.M Music Production & Engineering, cum laude', `I was the Head Studio Operations Assistant. I was responsible for making hiring recommendations and training new hires to our office; scheduling and staffing official recording sessions for other departments, as well as official promotional material for the school; engineering those sessions and delivering the final product on time and to spec; as well as providing support to other students who were working on their own projects.')
_end_section
